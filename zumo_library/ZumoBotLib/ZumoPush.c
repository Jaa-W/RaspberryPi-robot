...
#define S_FUNCTION_NAME ZumoPush
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void ZumoPush_Outputs_wrapper(boolean_T *State ,
			      const real_T  *xD,
                          const real_T  *sampleTime, const int_T p_width0);
extern void ZumoPush_Update_wrapper(const boolean_T *State ,
                           real_T *xD, 
                          const real_T  *sampleTime, const int_T  p_width0);
...
{
    boolean_T        *State  = (boolean_T *)ssGetOutputPortRealSignal(S,0);
    const real_T   *xD = ssGetDiscStates(S);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const real_T  *sampleTime  = (const real_T *)mxGetData(PARAM_DEF0(S));

    ZumoPush_Outputs_wrapper(State, xD, sampleTime, p_width0);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    ZumoPush_Update_wrapper(State,  xD, sampleTime, p_width0);
}

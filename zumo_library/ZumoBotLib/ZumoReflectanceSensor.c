 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Wed Oct 30 17:23:02 2013
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME ZumoReflectanceSensor
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      sensorReading
...
extern void ZumoReflectanceSensor_Outputs_wrapper(uint16_T *sensorReading,
                          real_T *line ,
			      const real_T  *xD,
...
extern void ZumoReflectanceSensor_Update_wrapper(const uint16_T *sensorReading,
                          const real_T *line ,
                          real_T *xD, 
                          const real_T  *sampleTime,  const int_T  p_width0,
                          const uint8_T  *emitterPin,  const int_T  p_width1,
...
{
    uint16_T        *sensorReading  = (uint16_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *line  = (real_T *)ssGetOutputPortRealSignal(S,1);
    ...
    const uint8_T  *emitterPin  = (const uint8_T *)mxGetData(PARAM_DEF1(S));
    const boolean_T  *debug  = (const boolean_T *)mxGetData(PARAM_DEF2(S));

    ZumoReflectanceSensor_Outputs_wrapper(sensorReading, line, xD, sampleTime, p_width0, emitterPin, p_width1, debug, p_width2);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    ZumoReflectanceSensor_Update_wrapper(sensorReading, line,  xD, sampleTime, p_width0, emitterPin, p_width1, debug, p_width2);
}
